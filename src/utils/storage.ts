...
export const INITIAL_SHOPPING_ITEMS: any[] = [
  ...
  },
  {
    ...
    unit: 'pack',
    priority: 'Medium',
    notes: 'Aashirvaad Shudh Chakki Atta',
    expectedPrice: 260.00,
...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: 'Amul Gold Milk',
    brand: 'Amul',
    expiryDate: '2026-07-26', // Expiring Soon
    mfdDate: '2026-07-10',
    category: 'Dairy',
    quantity: 1,
    unit: 'L',
    location: 'Refrigerator',
    notes: 'Pasteurized Full Cream',
  ...
  },
  {
    ...
    unit: 'pack',
    location: 'Kitchen',
    notes: 'Fresh white sliced bread',
