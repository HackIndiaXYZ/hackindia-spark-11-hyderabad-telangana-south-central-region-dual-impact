          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-1/2 px-3 py-2 text-sm bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white outline-none"
              />
              <input
                type="text"
                value={unit}
